...
GO
PRINT N'Creating [version].[Patch]...';
...
CREATE TABLE [version].[Patch] (
    ...
    PRIMARY KEY CLUSTERED ([PatchId] ASC)
);
...
GO
PRINT N'Creating unnamed constraint on [version].[Patch]...';


GO
ALTER TABLE [version].[Patch]
